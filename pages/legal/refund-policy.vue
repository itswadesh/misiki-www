<template>
  <div>
    <div class="h-full mx-2 mb-16 lg:mx-48">
      ...
      <ul>
        ...
        <li>
          ...
          deleted from the Service. Since deletion of all data is final please
          be sure that you do in fact want to cancel your account before doing
          so.
        </li>
        <li>
          We reserve the right to modify or terminate the Misiki service for any
          reason, without notice at any time.
        </li>
        <li>
          Fraud: Without limiting any other remedies, Misiki may suspend or
