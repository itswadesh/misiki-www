<template>
  <div class="flex flex-col">
    <div
      ...
      class="px-4 py-2 font-thin tracking-wide text-center bg-gray-800 text-primary-500"
    >
      We experiencing an incident and we are on it.
    </div>
    <header class="fixed top-0 z-10 w-full h-auto p-3 shadow-lg bg-primary-500">
      <div>
