<template>
  <div class="flex flex-col w-full">
    ...
    <div class="fx">
      ...
      <div class="m-choice m-align" v-else-if="d.time == '8:30 - 9:30 PM'">
        Dinner
      </div>
    </div>
    ...
    <div class="card-container">
      <div class="a-contain">
        ...
        <img v-if="d.type == 'N'" v-lazy="`/non-veg.png`" class="image-size" />
        <img v-else v-lazy="`/veg.png`" class="image-size" />
      </div>
